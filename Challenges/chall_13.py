...
def main():
    ...
    with xmlrpc.client.ServerProxy(server_url) as server_proxy:
        ...
        #     print('Method help for {}:'.format(method))
        #     print(server_proxy.system.methodHelp(method))
        #     print('Method signature for {}:'.format(method))
        #     print(server_proxy.system.methodSignature(method))
